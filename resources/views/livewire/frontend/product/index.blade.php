        ...
        <div class="col-md-3">
            ...
            @endif
                ...
                <div class="card mt-3">
                    ...
                    <div class="card-body">
                            <label class="d-block">
                                <input type="radio" name="priceSort" wire:model="priceInput" wire:click="applyFilter" value="high-to-low"/> High to Low
                            </label>
                        <label class="d-block">
                            <input type="radio" name="priceSort" wire:model="priceInput" wire:click="applyFilter" value="low-to-high"/> Low to High
                        </label>
                    </div>
                </div>
