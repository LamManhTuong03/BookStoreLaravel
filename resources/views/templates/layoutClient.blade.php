...
<head>
   <!-- Meta -->
	...
	<!-- STYLESHEETS -->
	<link rel="stylesheet" type="text/css" href="{{asset('client/assets/vendor/bootstrap-select/dist/css/bootstrap-select.min.css')}}">
	<link rel="stylesheet" type="text/css" href="{{asset('client/assets/icons/fontawesome/css/all.min.css')}}">
	<link rel="stylesheet" type="text/css" href="{{asset('client/assets/vendor/swiper/swiper-bundle.min.css')}}">
...
<!-- Footer End -->
    ...
    <script src="{{asset('client/assets/js/jquery.min.js')}}"></script><!-- JQUERY MIN JS -->
    <script src="{{asset('client/assets/vendor/wow/wow.min.js')}}"></script><!-- WOW JS -->
    <script src="{{asset('client/assets/vendor/bootstrap/dist/js/bootstrap.bundle.min.js')}}"></script><!-- BOOTSTRAP MIN JS -->
    <script src="{{asset('client/assets/vendor/bootstrap-select/dist/js/bootstrap-select.min.js')}}"></script><!-- BOOTSTRAP SELECT MIN JS -->
    <script src="{{asset('client/assets/vendor/counter/waypoints-min.js')}}"></script><!-- WAYPOINTS JS -->
    <script src="{{asset('client/assets/vendor/counter/counterup.min.js')}}"></script><!-- COUNTERUP JS -->
    <script src="{{asset('client/assets/vendor/swiper/swiper-bundle.min.js')}}"></script><!-- SWIPER JS -->
    <script src="{{asset('client/assets/js/dz.carousel.js')}}"></script><!-- DZ CAROUSEL JS -->
    <script src="{{asset('client/assets/js/dz.ajax.js')}}"></script><!-- AJAX -->
    <script src="{{asset('client/assets/js/custom.js')}}"></script><!-- CUSTOM JS -->
</body>
</html>
